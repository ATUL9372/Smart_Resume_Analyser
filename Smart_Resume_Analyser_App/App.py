...
import io, random
# from streamlit_tags import st_tagsCourses.py
...
connection = pymysql.connect(host='mysql57', user='myuser', password='mypass', database="sra")
...
def run():
    ...
    img = Image.open('./Logo/SRA_Logo.jpg')#from streamlit_tags import st_tagsCourses.py
    ...
    table_sql = "CREATE TABLE IF NOT EXISTS " + DB_table_name + """
                    (ID INT NOT NULL AUTO_INCREMENT,
                     ...
                     PRIMARY KEY (ID));
                    """
    cursor.execute(table_sql)#from streamlit_tags import st_tagsCourses.py
